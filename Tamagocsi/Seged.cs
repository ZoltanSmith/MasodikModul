namespace Tamagocsi
{
    internal static class Seged
    {
        static internal string[] allatNevek = new string[]
        {
            ...
            "Rex", "Bella", "Daisy", "Max", "Luna",
            "Bobi", "Cézár", "Mici", "Pamacs", "Tappancs",
            "Vacak", "Zsemle", "Kormos", "Hófehérke", "Picúr",
        ...
        [
            ...
            "Puli", "Vizsla", "Border Collie", "Perzsa macska", "Ragdoll",
            "Vörös róka", "Mezei nyúl", "Görény", "Csincsilla", "Axolotl",
            "Törpehörcsög", "Tacskó", "Mopsz", "Husky", "Maine Coon",
        ...
        static internal string[] allatEledelek = new string[]
        {
            ...
            "Széna", "Lucerna pellet", "Napraforgómag", "Túró", "Sütőtök püré",
            "Zöldborsó", "Főtt barna rizs", "Zabpehely", "Kutyakeksz", "Macskamentás jutalomfalat",
            "Füstölt fül (rágóka)", "Bárányhúsos pástétom", "Pulykanyak", "Spenótlevél", "Banánkarikák",
            "Kígyóuborka", "Cukkini", "Édesvízi halfilé", "Kókuszolaj", "Joghurt (natúr)"
        };
    }
}
